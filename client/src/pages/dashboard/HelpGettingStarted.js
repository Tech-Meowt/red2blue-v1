  ...
  return (
    <>
      ...
      <Wrapper>
        ...
        <h5>
          After you log in to the database for the first time, you should visit
          your <span className='emphasis'>profile</span> page to ensure that
          your information is correct and make any necessary edits. Any edits
          will take effect immediately. As mentioned on the profile page, if you
          edit your <span className='emphasis'>email address</span>, you'll need
          to use that address to <span className='emphasis'>log in</span>.
        ...
        <h5>
          The <span className='emphasis'>databases</span> that you have access
          to will vary based on your <span className='emphasis'>role</span>. In
          this tutorial, we'll navigate to the{' '}
          <span className='emphasis'>Sandbox tab</span>
        ...
        <h5>
          ...
          <span className='emphasis'>bottom </span> of a page, you can click on
          the <span className='emphasis'>arrow icons </span>located at the{' '}
          <span className='emphasis'>right top and right bottom </span>
        ...
        <h5>
          To <span className='emphasis'>add a new record </span>to a database,
          click on the <span className='emphasis'>Add button</span> underneath
          the search and filter options.{' '}
          <span className='emphasis'>
            Fill out all fields in the format provided.
          </span>
          When you're done, just click on{' '}
          <span className='emphasis'>Submit</span>
          —or if you've changed your mind, click on{' '}
          <span className='emphasis'>Cancel</span>. After adding a new record,
          you'll be <span className='emphasis'>redirected</span> back to the
          database's main page, which displays all records in{' '}
          <span className='emphasis'>ascending</span> order based on the date
        ...
        <h5>
          To <span className='emphasis'>edit an existing record</span>, start by
          navigating to the record and clicking on the{' '}
          <span className='emphasis'>Edit button</span> located near the bottom
          of the record. The edit form will be{' '}
          ...
          <span className='emphasis'>redirected</span> back to the database's
          main page, which displays all records in{' '}
          <span className='emphasis'>ascending </span>
          order based on the date that the record was created. This will be
          updated soon, but{' '}
          <span className='emphasis'>
            to see your edited record, you can use the search option to search
            for the record by first name, last name, or email
          </span>
        ...
        <h5>
          ...
          <span className='emphasis'>
            Clicking on the Delete button will permanently and instantly delete
            the record. There's no going back!
          </span>
        </h5>
        <div className='gif-div'>
          <img
        ...
        <h5>
          ...
          <span className='emphasis'>search </span>for a specific record, enter
          either into the search bar the{' '}
          <span className='emphasis'>
          ...
          . If you need to <span className='emphasis'>clear </span>your results,
          just click on <span className='emphasis'>Clear</span>. If you're
          looking for <span className='emphasis'>several records </span>that
          share something in common, you can{' '}
          <span className='emphasis'>filter </span>
          through the data to see multiple records at once. Each database will
          have different filtering options based on the data it holds.
        </h5>
        <div className='gif-div'>
          <img
            src={deleteRecord}
