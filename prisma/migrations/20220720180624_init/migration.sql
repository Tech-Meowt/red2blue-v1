/*
  ...
  - You are about to drop the column `eventsAttended` on the `Volunteer` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "Volunteer" DROP COLUMN "eventsAttended";

-- CreateTable
CREATE TABLE "NumOfEvents" (
    "id" TEXT NOT NULL,
    "eventsAttended" INTEGER NOT NULL DEFAULT 1,
